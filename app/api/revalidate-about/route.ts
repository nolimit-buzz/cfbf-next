...
import { ABOUT_CACHE_TAG } from '@/lib/cms/about';

/**
 * Webhook target for Strapi: purges the cached About page when an editor
 * publishes. Point the CMS at POST /api/revalidate-about with the shared secret
...
export async function POST(request: Request) {
  ...
  return Response.json({ revalidated: true, tag: ABOUT_CACHE_TAG });
}
