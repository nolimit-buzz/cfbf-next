              ...
              {TABS.map(tab => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2 rounded-[6px] text-sm font-semibold font-mono uppercase tracking-wider transition-all duration-200 border interactive ${
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="col-span-1 flex items-center gap-2">
                          ...
                          <span className={`text-sm font-sans font-medium truncate ${isHighlighted ? 'text-white' : 'text-gray-400'}`}>
                            {row.name}
                          </span>
                        </div>
